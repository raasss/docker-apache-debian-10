...
-	Issues can be filed at [GitHub Issues](https://github.com/raasss/docker-apache-debian-10/issues).

-	Supported architectures are: `linux/amd64`, `linux/arm/v7`, `linux/arm64` 

-	Source of this content can be found at [README.docker.io.md](https://github.com/raasss/docker-apache-debian-10/blob/main/README.docker.io.md)
